...
const AccountUser = () => {
    ...
    const uploadImage = async () => {
        ...
        data.append("upload_preset", "isywxhbb");
        data.append("cloud_name", "dbxn9aa2i");
        try {
    ...
    return (
        <div className='account-row'>
            <div className="title">
                ...
                <button className='add-btn' onClick={() => setOpenAdd(true)}>Add Product</button></div>
            <div className="account-groups">
                ...
                <div className="account-group">
                    ...
                    {openAdd && <AddProduct userInfo={userInfo} setOpenAdd={setOpenAdd} />}
                </div>
            </div>
        </div>
    )
